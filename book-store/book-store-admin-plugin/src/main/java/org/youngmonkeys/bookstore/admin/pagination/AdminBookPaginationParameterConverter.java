...
package org.youngmonkeys.bookstore.admin.pagination;
...
@EzySingleton
public class AdminBookPaginationParameterConverter
    extends BookPaginationParameterConverter {

    public AdminBookPaginationParameterConverter(
        ClockProxy clock,
