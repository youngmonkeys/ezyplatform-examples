...
import org.youngmonkeys.personal.socket.app.AppEntryLoader;
import org.youngmonkeys.personal.socket.plugin.PluginEntryLoader;

public class PersonalSocketAppStartupTest {

    private static final String APP_NAME = "personal";
    private static final String PLUGIN_NAME = "personal";
    private static final String ZONE_NAME = "personal";
        ...
        public EzyPluginEntry load() {
            return new PluginEntry() {
                ...
                protected String[] getScanablePackages() {
                    return new String[] { "org.youngmonkeys.personal" };
                }
            };
        }
    }
